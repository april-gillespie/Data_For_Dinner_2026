...
Exploratory allergen and gluten files are available in the local project workspace, but they are not finalized inputs and are not included in the active processed data, figures, findings, or reports. This document records future-work criteria only.
